...
<div class="wrapper">
  ...
  <nav class="navbar navbar-default navbar-static-top" role="navigation">
      ...
      <div class="text-right navbar-top-date"><?=date('l, F j, Y');?> | Logged in as: <strong><?=$_SESSION['custUsername'];?></strong> </div>
      ...
      <ul class="nav navbar-top-links navbar-right">
          <li class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-messages">
                  <?php echo list_message_snapshots($_SESSION['custEmail']); ?>
                  <li>
                      <a class="text-center" href="?tab=5">
          ...
          <li class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-user">                        
                  <li><a href="?tab=3&task=edit&eid=<?=$_SESSION['custUserID'];?>"><i class="fa fa-user fa-fw"></i> My Account</a></li>
                  <li class="divider"></li>
                  <li><a href="./?do=logout"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                  </li>
              </ul>
              <!-- /.dropdown-user -->
          </li>
      ...
      <div class="navbar-default sidebar" role="navigation">
          <div class="sidebar-nav navbar-collapse">
              <ul class="nav" id="side-menu">
                  ...
                  <li>                      
                      <a href="?tab=2" class="menu_link <?=$menu2?>"><i class="fa fa-shopping-cart fa-fw"></i> My Orders</a>
                  </li>
                  <li>
                      <a href="?tab=3" class="menu_link <?=$menu3?>"><i class="fa fa-user fa-fw"></i> My Account</a>
                  </li>
                  <li>
                      <a href="?tab=4" class="menu_link <?=$menu4?>"><i class="fa fa-map-marker fa-fw"></i> My Addresses</a>
                  </li>
                  <li>
                      <a href="?tab=5" class="menu_link <?=$menu5?>"><i class="fa fa-comments fa-fw"></i> Notifications</a>
                  </li>
              </ul>
  ...
  <div id="page-wrapper">
    ...
    switch ($tab) {
        ...
        break;
		case 3:
            require_once('customer.account.php');
        break;
		case 4:
            //require_once('customer.addresses.php');
        break;
		case 5:
...
db_close($conn);
	...
	redirect("./?url=".urlencode("customer.php?".$_SERVER['QUERY_STRING']));
}
