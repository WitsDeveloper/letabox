...
<!--
//Define page title
document.title = "<?=SYSTEM_SHORT_NAME?> | Customer Login";

//Basic submit validation
function Focus(){
	var username = document.custLogin.uname;
	username.focus();
}
function ValidateLogin(){
    var name= document.custLogin.uname;
	var password= document.custLogin.upass;
    ...
    <div class="col-md-4 col-md-offset-4">
      ...
      <div class="login-panel panel panel-default">
        ...
        <div class="panel-body">
          ...
          <form name="custLogin" method="post" action="?do=login&amp;url=<?=urldecode($url);?>">
            <fieldset>
