...
//Define page title
document.title = "<?=SYSTEM_SHORT_NAME?> | System Users";
</script>
        ...
        <div class="tab-content">
          ...
          <div id="tabs-2" class="tab-pane">
            ...
            <?php
              ...
              ?>
            <ol class="breadcrumb"><li><a href="admin.php" title="Dashboard">Dashboard</a></li><li><a href="admin.php?tab=6">Manage Users</a></li><li class="active">Login History</li></ol>
            <div id="hideMsg"><?php if(isset($UsrMSG)) echo $UsrMSG;?></div>
            <p class="text-center">ADMIN LOGIN HISTORY</p>
            
            <form name="view" method="post" action="admin.php?tab=6&task=view&userid=<?=$userID;?>#tabs-2">
...
?>
<ol class="breadcrumb"><li><a href="admin.php" title="Dashboard">Dashboard</a></li><li><a href="admin.php?tab=6">Manage Users</a></li><li class="active">System Users</li></ol>
...
<tr>
<td><?=$row['ID']?></td>
<td><a href="admin.php?tab=6&task=view&recid=<?=$i ?>&userid=<?=$row['ID']?>"><?=$row['FullName']?></a></td>
<td><?=$row['Username']?></td>
<td><?=$row["UserLevel"]?></td>
<td><?=$row['Email']?></td>
<?php
...
if($row['disabledFlag'] == 0){
	echo "<td align=\"center\"><a href=\"admin.php?tab=6&enable=1&eid=".$row['ID']."\" title=\"Click to disable ".$row['Username']."\"><img border=\"0\" src=\"".IMAGE_FOLDER."/icons/yes.png\" height=\"12\" width=\"12\" alt=\"Disable ".$row['Username']."\"></a></td>";
}else{
	echo "<td align=\"center\"><a href=\"admin.php?tab=6&enable=0&eid=".$row['ID']."\" title=\"Click to enable ".$row['Username']."\"><img border=\"0\" src=\"".IMAGE_FOLDER."/icons/no.png\" height=\"12\" width=\"12\" alt=\"Enable ".$row['Username']."\"></a></td>";
}
}else{
if($row['disabledFlag'] == 0){
...
?>
<td><a href="admin.php?tab=6&task=view&recid=<?=$i ?>&userid=<?=$row['ID']?>">View</a> | 
<?php if(isSuperAdmin()) { ?>
 <a href="admin.php?tab=6&task=edit&recid=<?=$i ?>&userid=<?=$row['ID']?>">Edit</a> | <a href="admin.php?tab=6&task=del&recid=<?=$i ?>&userid=<?=$row['ID']?>">Delete</a>
<?php }else{ ?>
 Edit | Delete
<?php } ?>
</tr>        
    ...
    <div class="col-md-6">
      ...
      if($a == 'add'){
          ...
          <div class="form-group">
            ...
            <span class=\"small\"><a href="admin.php?tab=6&amp;task=resetpass&amp;user=<?=$row['Email']?>">Click here to reset password for this account</a></span>
          </div>
          <?php
      }
      ?>
...
<a class="btn btn-primary" href="admin.php?tab=6&task=add">Add System User</a>
...
<div class="quick-nav btn-group">
<a class="btn btn-default" href="admin.php?tab=6"><i class="fa fa-undo fa-fw"></i> Back to Users</a>
<?php if ($recid > 0) { ?>
...
function viewrec($recid){
  ...
  $row = db_fetch_array($res);  
?>
<ol class="breadcrumb"><li><a href="admin.php" title="Dashboard">Dashboard</a></li><li><a href="admin.php?tab=6">Manage Users</a></li><li>View System User</li></ol>
<?php 
...
<td><a class="btn btn-default" href="admin.php?tab=6&task=add"><i class="fa fa-file-o fa-fw"></i>Add User</a></td>
<?php if(isSuperAdmin()) { ?>
<td><a class="btn btn-default" href="admin.php?tab=6&task=edit&recid=<?=$recid ?>&userid=<?=$row["ID"];?>"><i class="fa fa-pencil-square-o fa-fw"></i>Edit User</a></td>
<td><a class="btn btn-default" href="admin.php?tab=6&task=del&recid=<?=$recid ?>&userid=<?=$row["ID"];?>"><i class="fa fa-trash-o fa-fw"></i>Delete User</a></td>
<?php } ?>
</tr>
</table>
<?php
		...
		if(sizeof($ERRORS) > 0){
			...
			if(sql_insert($FIELDS)){
				...
				if(!$mail->Send()) {
					...
					redirect("admin.php?tab=6&task=view&offset=$returnOffset&page=$returnPageNo");
				}
			}
		}
	}
...
?>
<ol class="breadcrumb"><li><a href="admin.php" title="Dashboard">Dashboard</a></li><li><a href="admin.php?tab=6">Manage Users</a></li><li class="active">Add System User</li></ol>

<a class="btn btn-default" href="admin.php?tab=6"><i class="fa fa-undo fa-fw"></i> Back to System Users</a>
...
<ol class="breadcrumb"><li><a href="admin.php" title="Dashboard">Dashboard</a></li><li><a href="admin.php?tab=6">Manage Users</a></li><li class="active">Edit System User</li></ol>
<?php showrecnav("edit", $recid, $count); ?>
<form id="validateform" enctype="multipart/form-data" action="admin.php?tab=6&task=edit&recid=<?=$recid?>&userid=<?=$row["ID"];?>" method="post">
<p class="text-center"><?php echo !empty($ERRORS['MSG'])?$ERRORS['MSG']:"";?></p>
...
function deleterec($recid){
	...
	$row = db_fetch_array($res);
?>
<ol class="breadcrumb"><li><a href="admin.php" title="Dashboard">Dashboard</a></li><li><a href="admin.php?tab=6">Manage Users</a></li><li class="active">Delete System User</li></ol>
<?php showrecnav("del", $recid, $count); ?>
<form action="admin.php?tab=6&task=del&recid=<?=$recid?>&userid=<?=$row["ID"];?>" method="post">
...
?>
<ol class="breadcrumb"><li><a href="admin.php" title="Dashboard">Dashboard</a></li><li><a href="admin.php?tab=6">Manage Users</a></li><li class="active">Reset System User</li></ol>
<form action="admin.php?tab=6&task=resetpass&recid=<?=$recid?>&user=<?=$user?>" method="post">
...
<tr>
<td style="text-align:center" colspan="2"><?=recaptcha_get_html(RECAPTCHA_PUBLIC_KEY,$ERRORS['reCaptcha'],true);?><br><span class="text-danger"><?=$ERRORS['reCaptcha']?></span></td>
</tr>
<tr>
...
function sql_select(){
	...
	$sql = "SELECT `ID`,`FirstName`,`LastName`,CONCAT(`FirstName`,' ',`LastName`) AS `FullName`,`Username`,`Email`,`UserType`,`UserLevel`,`loggedIn`,`loginDate`,`token`,`disabledFlag` FROM `".DB_PREFIX."sys_users`";
	if (!empty($eid)) {
