      ...
      <div class="login-panel panel panel-default">
        ...
        <div class="panel-body">
          ...
          if(isset($_POST['Reset'])){
              ...
              $confirmEmailSql = sprintf("SELECT `Email` FROM `".DB_PREFIX."users` WHERE `Email` = '%s'", $thisEmail);
              ...
              if(sizeof($ERRORS) > 0){
                  ...
                  $updateSql = sprintf("UPDATE `".DB_PREFIX."users` SET `Token` = '%s' WHERE `Email` = '%s' LIMIT 1", $thisToken, $thisEmail);
              ...
              <form id="passresetform" name="PassReset" method="post" action="?do=reset">
                <fieldset>
                  ...
                  <div class="form-group">
                    ...
                    <?=recaptcha_get_html(RECAPTCHA_PUBLIC_KEY,$ERRORS['reCaptcha'],true);?><br><span class="text-danger"><?=$ERRORS['reCaptcha']?></span>
                  </div>
