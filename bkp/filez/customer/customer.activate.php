          ...
          if(getSysTokenUser($thisToken)){
              ...
              if(isset($_POST['Activate'])){
                  ...
                  if(sizeof($ERRORS) > 0){
                      ...
                      //Set SQL
                      $resetSQL = sprintf("UPDATE `".DB_PREFIX."users` SET `Password` = '%s', `Token` = NULL WHERE `Username` = '%s'", $encryptedpass, $thisUser);
                      //Run Query
              ...
              echo ErrorMessage("Invalid token! Try reset your account again.");
