                 ...
                 ?></td>
                          ...
                          print date("jS F, Y", strtotime("$obj_ona1->OrderDate"));
                           ?>                       
                                                ...
                                                <td>
 <?php if($obj_ona1->Status==0){ print 'pending';  } else{   print 'Processed';}
      ...
      ?>     
         ...
         print '<b>Kes</b> '.wits_money($obj_ona1->sellCostTotal).' for '.$count[0].' items';?> </td>
                                                <td>  
  <button type="button" data-toggle="modal" data-target="#orderView" data-id="<?php print $obj_ona1->OrderId;?>" class="my_butt">View</button>                                            
 <!--<a data-toggle="modal" href="#orderView" class="my_butt" data-id="<?php //print $obj_ona1->OrderId;?>"  > 
   <!-- <a data-toggle="modal" href="my-account.php?view=ona_order&orderId=<?php //print $obj_ona1->OrderId;?>" class="my_butt">-View </a> --></td>                  
                                            </tr>
	<?php }
	echo '</table>';
