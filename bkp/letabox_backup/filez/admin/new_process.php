...
$Email=$obj_ona133->Email;
 $body="Your Order has been successfully proccessed.</br> Order ID #".$OrderId."<br/>We Shall inform you once its ready for pick Up ";
...
$obj_ona133= $project_desc133->fetch_object();
$Email=$obj_ona133->Email;
 $body="Your Order has been successfully Picked/released.</br> Order ID #".$OrderId."<br/>Incase of any issue call us on 0789898989 ";
 $mail = new PHPMailer(true);                            
try {  
    //$mail->SMTPDebug = 1;                              
    $mail->isSMTP();                                   
