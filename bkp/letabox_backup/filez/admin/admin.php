      ...
      <ul class="nav navbar-top-links navbar-right">
          <li class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-messages">
                  ...
                  <li>
                      <a class="text-center" href="?tab=4">
          ...
          <li class="dropdown">
              ...
              <ul class="dropdown-menu dropdown-user">                        
                  <li><a href="?tab=6&task=edit&eid=<?=$_SESSION['sysUserID'];?>"><i class="fa fa-user fa-fw"></i> User Profile</a>
                  </li>
                  <li><a href="?tab=7&task=edit"><i class="fa fa-gear fa-fw"></i> Settings</a>
                  </li>
                  <li class="divider"></li>
      ...
      <div class="navbar-default sidebar" role="navigation">
          <div class="sidebar-nav navbar-collapse">
              <ul class="nav" id="side-menu">
                  ...
                  <li>                      
                      <a href="?tab=2" class="menu_link <?=$menu2?>"><i class="fa fa-sitemap fa-fw"></i> Categories</a>
                  </li>
                  <li>
                      <a href="?tab=3" class="menu_link <?=$menu3?>"><i class="fa fa-shopping-cart fa-fw"></i> Orders</a>
                  </li>                  
                  <li>
                      <a href="?tab=4" class="menu_link <?=$menu4?>"><i class="fa fa-comments fa-fw"></i> Messages</a>
                  </li>
                  <li>
                      <a href="?tab=5" class="menu_link <?=$menu5?>"><i class="fa fa-users fa-fw"></i> Customers</a>
                  </li>
                  <li>
                      <a href="?tab=6" class="menu_link <?=$menu6?>"><i class="fa fa-users fa-fw"></i> System Users</a>
                  </li>
                  <li>
                      <a href="?tab=7" class="menu_link <?=$menu7?>"><i class="fa fa-gear fa-fw"></i> Settings</a>
                  </li>
              </ul>
