    ...
    <button type="button" id="myElement2" class="navbar-toggle drawer-handle2" >
        ...
        <span class="icon-bar"></span> 
			...
			<ul class="right">
				...
				<?php } else{ ?>
				<li><a onclick="location.href='../signup.php';" class="signupModal hide_mob">Sign up</a></li>
				<li><a onclick="location.href='../signin.php';"   class="signinModal hide_mob">Sign in</a></li>
				<?php } ?>
                                <?php } else{ ?>
                                <?php    if(isset($_SESSION["user_id"])){?>
                            <li><a href="my-account.php" class="hide_mob"> Orders</a></li>
...
<div id="wits_barx2" class="hide_desk">   
    ...
    <ul class="mob_drop">
           ...
           <?php    if(isset($_SESSION["user_id"])){?>
        <li><a href="my-profile.php" class="hide_desk wits_barx2_acc"> <i class="fas fa-user-circle"></i> <span style="color: #2f2f2e;font-weight: bold;">My Profile</span></a></li>
        <li><a href="?account=logout" class="hide_desk wits_barx2_acc"> <i class="fas fa-power-off"></i><span style="color: #2f2f2e;font-weight: bold;">Logout</span></a></li>
         <li><a href="my-account.php" class="hide_desk wits_barx2_acc"> <i class="fas fa-shopping-basket"></i><span style="color: #2f2f2e;font-weight: bold;">Orders</span></a></li>
				<?php } else{ ?>
        <li><a onclick="location.href='../signup.php';" class="signupModal hide_desk wits_barx2_acc"> <i class="fas fa-sign-out-alt"></i> <span style="color: #2f2f2e;font-weight: bold;">Sign up</span></a></li>
        <li><a onclick="location.href='../signin.php';"  class="signinModal hide_desk wits_barx2_acc"> <i class="fas fa-sign-in-alt"></i><span style="color: #2f2f2e;font-weight: bold;">Sign in</span></a></li>
        <li><a href="../my" class="hide_desk wits_barx2_acc"><span style="color: #2f2f2e;font-weight: bold;"> <i class="fas fa-shopping-basket"></i>Orders</span></a></li>
				<?php } ?>
                                    <li><a href="#"> <i class="fas fa-users"></i>About</a></li>
                                     <li><a href="#"> <i class="fas fa-comment-alt"></i>Contact</a></li>
                                      <li><a href="#"> <i class="fas fa-question"></i>FAQs</a></li>
                                      <li><a href="#"> <i class="fas fa-certificate"></i>Guarantee</a></li>   
                                      <li><a href="no-results.php"> <i class="far fa-share-square"></i>Get a Quote</a></li> 
